...
The background noise from a cavity is governed by blackbody radiation. 
...
constant, and $k_{\rm B}$ is the Boltzmann constant. The first and the second 
...
resonance frequency $\omega_{\rm c}/2\pi$ in this scenario, the model in 
...
is also coupled to the environment modes $a_0$, representing the intrinsic 
loss channels of the cavity body, with a rate $\kappa_0$. In a steady state, 
...
$a_{\rm 2,in}$ comes from a nearby cold attenuator in the transmission line 
with a temperature $T_{\rm att} \equiv T_{\rm 2}$, and $a_{\rm 0,in}$ comes 
from the cavity body with a temperature $T_{\rm c} \equiv T_{\rm 0}$.
...
$\kappa_0+\kappa_{\rm 2}$. Therefore, the noise spectrum has a white background
 determined by the incoming noise of the attenuator with an effective 
temperature $\Tilde{T}_{\rm att}$, plus an excess Lorentzian peak centered at 
$\omega_{\rm c}$ determined by the effective temperature difference 
$\Tilde{T}_{\rm c} - \Tilde{T}_{\rm att}$. (The center Lorentzian structure 
can even be a dip if ${T}_{\rm c} < {T}_{\rm att}$.)

\begin{figure}[htbp]
    \centering
    \includegraphics[width=8.6cm]{figures/inout.png}
    \caption{A cavity is coupled to the modes of transmission line $a_2$ with 
the rate $\kappa_2$ and the modes of environment $a_0$ with the rate 
$\kappa_0$.}
