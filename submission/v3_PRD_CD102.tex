...
Using a “sidecar” cavity and a Josephson Traveling Wave Parametric Amplifier, 
ADMX G2 had recently searched for axions at around 
...
of 4.779-4.788~GHz, %4.77775-4.78731 GHz, 
during which the CD102 data were recorded after a magnet quench at 09:20
...
period, an earthquake of the intensity scale 4 
struck the lab at 13:11 on October 24~\footnote{In Taiwan, an intensity 4 
earthquake has a strong ground acceleration of 25--80~cm/s$^2$.}. 
%%%%% 
...
While Ref.~\cite{HAYSTACII} takes into account the correlation of the 
uncertainties between different frequency bins, this paper adopts a simple 
and conservative approach and considers the uncertainties are uncorrelated. 
The frequency-domain spectra processed by each intermediate 
...
the synthetic axion signals produced by a vector signal generator (VSG) were 
injected into the cavity and read out via the 
...
data acquisition and physics analysis. The hardware synthetic axion signals 
...
In order to validate the results of the SNRs, 
the analysis procedure is also applied  
to the software simulated spectra that include both noise and a signal with 
the same power and the same line shape as those of the hardware 
injected synthetic axions from the VSG. 
...
on the $\left|g_{a\gamma\gamma}\right|$ limits on average. 
...
\item Uncertainty due to the frequency misalignment (see Sec.~\ref{sec:merge}):
  ...
  on the limit, which is used as the systematic 
  uncertainty from the misalignment. The average of the uncertainties from 
  all frequency bins is 2.8\%.
...
approaches are in general within 1\%; the 
maximum deviation of 1.8\% 
on the $\left|g_{a\gamma\gamma}\right|$ limit is used, uniformly for all 
frequency bins, as a conservative estimate of the systematic uncertainty from 
the SG filter. 
...
The average of the total relative systematic uncertainty from all frequency 
bins is $\approx 4.6\%$.
...
\bibitem [{\citenamefont {Wilczek}(1978)}]{strongCPIII}%
  ...
  {NoStop}%
\bibitem [{\citenamefont {Abel}\ \emph {et~al.}(2020)\citenamefont {Abel} \emph
  {et~al.}}]{EDM}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {C.}~\bibnamefont
  {Abel}} \emph {et~al.} (\bibinfo {collaboration} {nEDM}),\ }\href
  {https://doi.org/10.1103/PhysRevLett.124.081803} {\bibfield  {journal}
  {\bibinfo  {journal} {Phys. Rev. Lett.}\ }\textbf {\bibinfo {volume} {124}},\
  \bibinfo {pages} {081803} (\bibinfo {year} {2020})}\BibitemShut {NoStop}%
...
\bibfield  {number} {  }\bibfield  {author} {\bibinfo {author} {\bibfnamefont
  ...
  {journal} {J. High Energ. Phys.}\ }\textbf {\bibinfo {volume} {03}}\bibinfo
  {number} { (2016)},\ \bibinfo {pages} {155}}\BibitemShut {NoStop}%
...
\bibitem [{\citenamefont {Gorghetto}\ \emph {et~al.}(2018)\citenamefont
  {Gorghetto}, \citenamefont {Hardy},\ and\ \citenamefont
  {Villadoro}}]{QCDCalXIV}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {M.}~\bibnamefont
  {Gorghetto}}, \bibinfo {author} {\bibfnamefont {E.}~\bibnamefont {Hardy}},\
  and\ \bibinfo {author} {\bibfnamefont {G.}~\bibnamefont {Villadoro}},\ }\href
  {https://doi.org/10.1007/JHEP07(2018)151} {\bibfield  {journal} {\bibinfo
  {journal} {J. High Energ. Phys.}\ }\textbf {\bibinfo {volume} {07}}\bibinfo
  {number} { (2018)},\ \bibinfo {pages} {151}}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Kim}(1979)}]{KSVZI}%
  \BibitemOpen
\bibfield  {number} {  }\bibfield  {author} {\bibinfo {author} {\bibfnamefont
  {J.~E.}\ \bibnamefont {Kim}},\ }\href
  {https://doi.org/10.1103/PhysRevLett.43.103} {\bibfield  {journal} {\bibinfo
  {journal} {Phys. Rev. Lett.}\ }\textbf {\bibinfo {volume} {43}},\ \bibinfo
  {pages} {103} (\bibinfo {year} {1979})}\BibitemShut {NoStop}%
...
\bibitem [{\citenamefont {Sikivie}(2021)}]{AxionReview}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {P.}~\bibnamefont
  {Sikivie}},\ }\href {https://doi.org/10.1103/RevModPhys.93.015004} {\bibfield
   {journal} {\bibinfo  {journal} {Rev. Mod. Phys.}\ }\textbf {\bibinfo
  {volume} {93}},\ \bibinfo {pages} {015004} (\bibinfo {year}
...
\bibitem [{\citenamefont {Brubaker}\ \emph
  ...
  {NoStop}%
\bibitem [{\citenamefont {Turner}(1990)}]{SignalLineShapeI}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {M.~S.}\ \bibnamefont
  {Turner}},\ }\href {https://doi.org/10.1103/PhysRevD.42.3572} {\bibfield
  {journal} {\bibinfo  {journal} {Phys. Rev. D}\ }\textbf {\bibinfo {volume}
  {42}},\ \bibinfo {pages} {3572} (\bibinfo {year} {1990})}\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Lisanti}(2017)}]{Lisanti:2016jxe}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {M.}~\bibnamefont
  {Lisanti}},\ }in\ \href {https://doi.org/10.1142/9789813149441_0007} {\emph
  {\bibinfo {booktitle} {{Theoretical Advanced Study Institute in Elementary
  Particle Physics}: {New Frontiers in Fields and Strings}}}}\ (\bibinfo {year}
  {2017})\ pp.\ \bibinfo {pages} {399--446}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Green}(2017)}]{Green:2017odb}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {A.~M.}\ \bibnamefont
  {Green}},\ }\href {https://doi.org/10.1088/1361-6471/aa7819} {\bibfield
  {journal} {\bibinfo  {journal} {J. Phys. G: Nucl. Part. Phys.}\ }\textbf
  {\bibinfo {volume} {44}},\ \bibinfo {pages} {084001} (\bibinfo {year}
  {2017})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Brown}\ \emph {et~al.}(2018)\citenamefont {Brown}
  \emph {et~al.}}]{GAIA}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {A.~G.~A.}\
  \bibnamefont {Brown}} \emph {et~al.} (\bibinfo {collaboration} {Gaia
  Collaboration}),\ }\href {https://doi.org/10.1051/0004-6361/201833051}
  {\bibfield  {journal} {\bibinfo  {journal} {{Astronomy \& Astrophysics}}\
  }\textbf {\bibinfo {volume} {616}},\ \bibinfo {pages} {A1} (\bibinfo {year}
  {2018})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Evans}\ \emph {et~al.}(2019)\citenamefont {Evans},
  \citenamefont {O'Hare},\ and\ \citenamefont {McCabe}}]{Evans:2018bqy}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {N.~W.}\ \bibnamefont
  {Evans}}, \bibinfo {author} {\bibfnamefont {C.~A.~J.}\ \bibnamefont
  {O'Hare}},\ and\ \bibinfo {author} {\bibfnamefont {C.}~\bibnamefont
  {McCabe}},\ }\href {https://doi.org/10.1103/PhysRevD.99.023012} {\bibfield
  {journal} {\bibinfo  {journal} {Phys. Rev. D}\ }\textbf {\bibinfo {volume}
  {99}},\ \bibinfo {pages} {023012} (\bibinfo {year} {2019})}\BibitemShut
  {NoStop}%
...
\bibitem [{\citenamefont {Chang}\ \emph {et~al.}(2022)\citenamefont {Chang},
  ...
  \citenamefont {Chang}, \citenamefont {Chen}, \citenamefont {Chen},
  \citenamefont {Chen}, \citenamefont {Chen}, \citenamefont {Chiang},
  \citenamefont {Chien}, \citenamefont {Doan}, \citenamefont {Hung},
  \citenamefont {Kuo}, \citenamefont {Lai}, \citenamefont {Liu}, \citenamefont
  {OuYang}, \citenamefont {Wu},\ and\ \citenamefont
  {Yu}}]{TASEHInstrumentation}%
  \BibitemOpen
  ...
  {2022})},\ \bibinfo {note} {accepted by Review of Scientific Instruments},\
  \Eprint {https://arxiv.org/abs/2205.01477} {arXiv:2205.01477
  [physics.ins-det]} \BibitemShut {NoStop}%
\bibitem [{Note1()}]{Note1}%
  \BibitemOpen
  \bibinfo {note} {In Taiwan, an intensity 4 earthquake has a strong ground
  acceleration of 25--80~cm/s$^2$.}\BibitemShut {Stop}%
