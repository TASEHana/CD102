...
range of 4--40\muevcc\ (1--10~GHz), similarly for the 
other haloscope experiments that were established during the last ten years.  
...
$T_\text{b}=\left(\frac{1}{e^{\left.hf\middle/k_BT_\mathrm{c}\right.}-1}\right)\left. hf\middle/k_B\right.$, the blackbody 
...
More details may be found in Sec.~\ref{sec:taseh} and Appendix~\ref{sec:cavitynoise}. 
