...
%        %\item Set threshold at ${3.355\ \sigma}$.
       \item Rescan the frequency regions with candidates and set limit on 
...
which corresponds to a candidate threshold of 3.355$\sigma$ at 95\% confidence.
 After the merging, if there is any potential signal with an SNR larger than 
3.355$\sigma$, a rescan will be proceeded to check if it is a real signal or 
