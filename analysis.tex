...
are also cross-checked with 10000 pseudo-experiments that include simulations 
...
has been studied and the variation on the \gagg\ limits is quoted as a part of 
the systematic uncertainty, see Sec.~\ref{sec:sys}.
