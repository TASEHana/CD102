...
The relative deviation of power in the normalized spectrum and also in the 
spectra processed with rescaling, combining, and merging afterwards are 
denoted by the symbol $\delta$ and referred to as ``RDP''. The values of 
