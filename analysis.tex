...
and formulas for each step are 
listed below for the convenience of the readers. Note there are a few  
...
also shown for comparison in Sec.~\ref{sec:results}.
...
\begin{equation}
    ...
    w_{gk} = \frac{L_{k}}{(\sigma_{g+k-1}^\text{com})^{2}},
\end{equation}
 in which 
\begin{equation}
